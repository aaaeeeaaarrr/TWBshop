...
async def extract_receipt(image_bytes: bytes) -> dict:
    ...
    prompt = (
        ...
        "— read the number written by each (a 2-digit year like '26' means 2026). Give YYYY-MM-DD ONLY "
        "when the day, month AND year are EACH clearly readable; if any one of them is blank or "
        "illegible, return null — never guess the missing part\n"
