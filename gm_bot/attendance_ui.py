...
def rules_screen(p: dict) -> tuple[str, InlineKeyboardMarkup]:
    ...
    return _hdr(p,
                ...
                "• Sick: never costs your salary. Send a doctor's note within 2 days and you owe no "
                "pay-back for that day — without one, you make the hours up later.\n"
                "• ឈឺ៖ មិនដកប្រាក់ខែទេ។ បើផ្ញើលិខិតពេទ្យក្នុង 2 ថ្ងៃ ប្អូនមិនត្រូវសងម៉ោងវិញសម្រាប់ថ្ងៃនោះទេ — "
                "បើមិនមានលិខិតពេទ្យ ប្អូនត្រូវធ្វើសងម៉ោងវិញពេលក្រោយ។\n\n"
                "• Special Leave (marriage, family death, birth): see the menu — money is never "
                "taken for these.\n"
                "• ច្បាប់ពិសេស (រៀបការ, មរណភាពគ្រួសារ, ប្រពន្ធសម្រាលកូន)៖ សូមមើលក្នុង menu — "
