...
def test_just_inside_and_outside_150m():
    # 150m zone (session 38, Jun 16): ~0.001 deg lat ≈ 111m -> inside; ~0.0015 deg ≈ 167m -> outside.
    assert att.in_work_zone(att.TWB_LAT + 0.001, att.TWB_LNG) is True
    assert att.in_work_zone(att.TWB_LAT + 0.0015, att.TWB_LNG) is False
