...
**Last updated:** 2026-06-21 (session 51 — **DEPLOYED: 7 GM attendance fixes live + Heng/Long data-fixes applied with proof**).
...
**▶ STILL OPEN:** ⑨ Bug B (Heng's worked 7-min tail credited 0 — the settle root-cause; data-fixed for Heng, never-again needs a careful staging repro).
